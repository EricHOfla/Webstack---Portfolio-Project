...
// if ($method=$_POST['method'] =="Full Payment") {
//   echo "<script type='text/javascript'> document.location = 'includes/request.php'; </script>";
// }
// else{
...
<title>Bike Sell Port | Vehicle Details</title>
<!--Bootstrap -->
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>RWF <?php echo htmlentities($result->PricePerDay);?> </p>
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap">
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              ...
              <li role="presentation"><a href="#Product-Parameter" aria-controls="Product-Parameter" role="tab" data-toggle="tab">Product Parameter</a></li>
            </ul>
...
<?php } ?>
  ...
  <!-- Accessories -->
  <div role="tabpanel" class="tab-pane" id="Product-Parameter">
                <!--Accessories-->
                <table>
                  <thead>
                    <tr>
...
<td><p> <?php echo htmlentities($result->Displacement);?> </p></td>
   </tr>

<tr>
<td>Max power(kw/rpm)</td>
<td><p> <?php echo htmlentities($result->Maxpower);?> </p></td>
</tr>


<tr>
<td>Max torque</td>
<td><p> <?php echo htmlentities($result->Maxtorque);?> </p></td>
</tr>

<tr>
<td>Dimension(mm)</td>
<td><p> <?php echo htmlentities($result->Dimension);?> </p></td>
</tr>
<tr>

<td>Wheelbase (mm)</td>
<td><p> <?php echo htmlentities($result->Wheelbase);?> </p></td>
</tr>

<tr>
<td>Net weight (kg)</td>
<td><p> <?php echo htmlentities($result->Netweight);?> </p></td>
</tr>

<tr>
<td>Min ground clearence</td>
<td><p> <?php echo htmlentities($result->Mingroundclearence);?> </p></td>
</tr>

<tr>
<td>Front tyre</td>
<td><p> <?php echo htmlentities($result->Fronttyre);?> </p></td>
</tr>

<tr>
<td>Rear tyre</td>
<td><p> <?php echo htmlentities($result->Reartyre);?> </p></td>
</tr>

<tr>
<td>Fuel tank capacity (L)</td>
<td><p> <?php echo htmlentities($result->Fueltankcapacity);?> </p></td>
</tr>

<tr>
<td>Sitting height (mm)</td>
<td><p> <?php echo htmlentities($result->Sittingheight);?> </p></td>
</tr>
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-envelope" aria-hidden="true"></i>Purchase Now</h5>
          </div>
          <form method="post">
          <?php if($_SESSION['login'])
              {?>
               ...
               <?php   echo'  <a href=includes/payment75.php?vhid='.$vhid.'' ?> class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Purchese</a>
                  ...
                  <?php } else { ?>
              <a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login For Purchese</a>
              <?php } ?>
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
              ...
              <p class="list-price">RWF <?php echo htmlentities($result->PricePerDay);?></p>
...
<?php include('includes/pay100/requestfull.php');?>
<?php include('includes/pay75/request75.php');?>
