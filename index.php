...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>You will be able to fully enjoy your transport and your ride! Any problems? Our passionate team will be happy to help you!! No waste of time during your holidays to find a sell point on the spot! No language barrier, thanks to our multilingual team! At the same price you would pay on the partial of 75%! We have best bikes with best deals</p>
    </div>
    <div class="row">
...
<span class="price">rwf<?php echo htmlentities($result->PricePerDay);?></span>
</div>
...
<?php include('includes/requestfull.php');?>
